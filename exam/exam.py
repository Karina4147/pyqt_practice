""" «Монитор ресурсов системы»
    ...
    Отображение в таблице/списке текущих «ресурсов»:
    CPU: % загрузки,
    RAM: использовано/доступно,
    Диск: использовано/доступно.

    Обновление данных каждые N миллисекунд/секунд:
    выполняется в фоновом потоке, интерфейс не блокируется.
    Возможность:
    ...
    в цикле с заданным интервалом собирает/генерирует данные, отправляет их в UI через сигнал.
