...
class Window(QtWidgets.QWidget):
    ...
    def initSignals(self) -> None:
        ...
        self.pushButtonTimeEdit.clicked.connect(self.onPushButtonTimeEdiClicked)
        self.pushButtonDateTimeEdit.clicked.connect(self.onPushButtonDateTimeEdit)
    ...
    def onPushButtonTimeEdiClicked(self):
        self.plainTextEditLog.setPlainText(self.timeEdit.time().toString("hh:mm:ss"))

    def onPushButtonDateTimeEdit(self):
        self.plainTextEditLog.setPlainText(self.dateTimeEdit.dateTime().toString("yyyy-mm-dd hh:mm:ss"))

    def onPushButtonClearLogClicked(self):
        self.plainTextEditLog.clear()

    def onComboBoxIndexChanged(self, index: int):
        self.plainTextEditLog.appendPlainText(f" {index}")

    def onSpinBoxValueChanged(self, value: int):
        self.plainTextEditLog.appendPlainText(f"{value}")

    def onDateTimeEditChanged(self, dt: QtCore.QDateTime):
        self.plainTextEditLog.appendPlainText(f"{dt.toString('yyyy-mm-dd hh:mm:ss')}")
